      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className={isDark ? 'text-white/90' : 'text-gray-900'}>今日推荐</h3>
          </div>
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-xl">📚</span>
            <h3 className={isDark ? 'text-white/90' : 'text-gray-900'}>精选绘本</h3>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {books.map((book) => (
              <div
                key={book.id}
                className={`${isCyber ? 'cyber-card' : isAurora ? 'aurora-card' : 'glass-card'} overflow-hidden group cursor-pointer`}
              >
                <div className={`relative aspect-[3/4] flex items-center justify-center ${
                  ...
                  {/* Category Badge */}
                  <div className={`absolute top-2 left-2 px-2 py-1 text-white rounded-full text-xs flex items-center gap-1 ${
                    isCyber
                ...
                <div className="p-3">
                  <h4 className={`mb-1 line-clamp-1 ${isDark ? 'text-white/90' : 'text-gray-900'}`}>{book.title}</h4>
                  <p className={`text-xs ${isDark ? 'text-white/50' : 'text-gray-500'}`}>{book.category}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="text-center py-8">
          ...
          <p className={`text-sm ${isDark ? 'text-white/50' : 'text-gray-500'}`}>更多精彩绘本即将上线</p>
        </div>
      </div>
