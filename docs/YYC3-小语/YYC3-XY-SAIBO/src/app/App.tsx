...
const AppContent: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen relative overflow-hidden ${isCyberpunk ? 'theme-cyberpunk' : 'theme-liquid-glass'}`}>
      {/* Background Layer */}
      {isCyberpunk ? (
        <CyberpunkBackground particleCount={20} streamCount={8} />
      ) : (
            ...
            <div className="glass-card glass-card-strong p-8 mb-6">
              <div className="flex items-center gap-6 mb-6">
                <motion.div
                  ...
                  style={{ boxShadow: isCyberpunk ? '0 0 20px rgba(0, 240, 255, 0.3)' : '0 8px 30px rgba(16, 185, 129, 0.2)' }}
                >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  { value: '15', label: '学习天数', gradient: isCyberpunk ? 'from-[#00f0ff] to-[#0088cc]' : 'from-emerald-400 to-green-500' },
                  { value: '8', label: '完成课程', gradient: isCyberpunk ? 'from-[#ff00ff] to-[#8800cc]' : 'from-teal-400 to-cyan-500' },
                  { value: '4', label: '获得成就', gradient: isCyberpunk ? 'from-[#00ff41] to-[#00cc33]' : 'from-green-400 to-emerald-500' },
                  { value: '12', label: '文化探索', gradient: isCyberpunk ? 'from-[#ffff00] to-[#ff8800]' : 'from-emerald-500 to-teal-500' },
                ].map((stat) => (
                  <motion.div
                    key={stat.label}
                ...
                {mockGrowthData.achievements.map((achievement) => (
                  ...
                  >
                    <div
                      ...
                      style={{ boxShadow: isCyberpunk ? '0 0 20px rgba(255, 136, 0, 0.4)' : '0 6px 20px rgba(245, 158, 11, 0.3)' }}
                    >
                      {achievement.icon}
                    </div>
