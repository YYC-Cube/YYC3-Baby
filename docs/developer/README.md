...
> 面向开发者的完整技术文档。配套用户向导见[项目 README](../../README.md)，历史资料见 [docs/](../) 各归档库。

| 文档 | 内容 |
|------|------|
| [01 · 快速上手](./01-getting-started.md) | 环境要求、安装、启动、常见问题 |
| [02 · 可视化架构体系](./02-architecture.md) | 系统分层图 / 混合路由 / 数据流 / AI 链路 / 目录拓扑（Mermaid） |
...
| [09 · 贡献指南](./09-contributing.md) | 分支模型、提交规范、徽章系统扩展指南 |
