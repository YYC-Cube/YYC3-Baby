...
```json
{
  ...
  "license": "MIT",
  "homepage": "https://github.com/YY-Nexus/{project-name}#readme",
  "repository": {
    "type": "git",
    "url": "https://github.com/YY-Nexus/{project-name}.git"
  },
  "bugs": {
    "url": "https://github.com/YY-Nexus/{project-name}/issues"
  },
  "keywords": [
    "yyc3",
    "{category}",
...
```bash
# 克隆项目
git clone https://github.com/YY-Nexus/{项目名称}.git
cd {项目名称}
