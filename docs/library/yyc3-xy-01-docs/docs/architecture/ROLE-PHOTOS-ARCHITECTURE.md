...
本文档描述了 `/Users/yanyu/yyc3-xy-ai/public/role-photos` 目录的结构，符合YYC³团队标准化规范。
...
├── boy/
│   ├── ai-avatars/
│   │   ├── boy-xiaoyan-casual-001.png
│   │   ├── boy-xiaoyan-casual-002.png
│   │   ├── boy-xiaoyan-casual-003.png
│   │   ├── boy-xiaoyan-cool-001.png
│   │   └── boy-xiaoyan-cool-002.png
...
├── girl/
│   ├── ai-avatars/
│   │   ├── girl-xiaoyu-lolita-blue-001.png
│   │   ├── girl-xiaoyu-lolita-blue-002.png
│   │   ├── girl-xiaoyu-lolita-pink-001.png
│   │   └── girl-xiaoyu-lolita-pink-002.png
...
// 引用男孩角色的AI生成头像
const boyAIAvatar = '/role-photos/boy/ai-avatars/boy-xiaoyan-casual-001.png';

// 引用女孩角色的萝莉风格头像
const lolitaAvatar = '/role-photos/girl/xiaoyu-lolita-blue-008.png';

// 引用女孩角色的AI生成头像
const girlAIAvatar = '/role-photos/girl/ai-avatars/girl-xiaoyu-lolita-pink-001.png';
...
| 版本 | 日期 | 更新内容 | 作者 |
|------|------|----------|------|
| 1.0.0 | 2025-12-28 | 初始文档创建，目录结构优化说明 | YYC³团队 |
| 1.1.0 | 2025-12-28 | 添加角色详细信息 | YYC³团队 |
