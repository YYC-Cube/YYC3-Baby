...
const xiaoyuConfig: CharacterConfig = {
  ...
  expressions: [
    ...
    },
    {
      ...
      name: '庆祝',
      trigger: 'celebration',
      imagePath: '/role-photos/girl/xiaoyu-lolita-pink-002.png',
    ...
    },
    {
      ...
      imagePath: '/role-photos/girl/xiaoyu-lolita-pink-003.png',
    ...
    },
    {
      ...
      name: '安慰',
      trigger: 'comfort',
      imagePath: '/role-photos/girl/xiaoyu-lolita-pink-005.png',
    ...
    },
    {
      ...
      name: '思考',
      trigger: 'thinking',
      imagePath: '/role-photos/girl/xiaoyu-lolita-pink-006.png',
...
const xiaoyanConfig: CharacterConfig = {
  ...
  images: {
    ...
    additionalImages: [
      ...
      '/role-photos/boy/xiaoyan-cool-003.png',
      '/role-photos/boy/xiaoyan-formal-001.png',
      '/role-photos/boy/xiaoyan-formal-002.png',
      '/role-photos/boy/xiaoyan-formal-003.png',
      '/role-photos/boy/xiaoyan-formal-005.png',
      '/role-photos/boy/xiaoyan-formal-006.png',
      '/role-photos/boy/xiaoyan-formal-007.png'
    ]
  },
  createdAt: new Date('2025-01-30'),
  updatedAt: new Date('2025-01-30')
