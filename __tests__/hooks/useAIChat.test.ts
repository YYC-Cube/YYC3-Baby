...
// 模拟API客户端
const mockGetAIRoles = mock(() => Promise.resolve({ success: true, data: { aiRoles: [] } }))
const mockGetConversationHistory = mock(() => Promise.resolve({ success: true, data: { conversations: [] } }))
const mockGetAISessions = mock(() => Promise.resolve({ success: true, data: { sessions: [] } }))
const mockChat = mock(() => Promise.resolve({ success: true, data: { response: '' } }))
const mockGetChatStats = mock(() => Promise.resolve({ success: true, data: { stats: {} } }))
