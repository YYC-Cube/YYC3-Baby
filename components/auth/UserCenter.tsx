...
export default function UserCenter() {
    ...
    return (
      <>
        <motion.button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-linear-to-r from-blue-500 to-purple-500 text-white rounded-full text-sm font-medium hover:opacity-90 transition-opacity"
  ...
  return (
    <div className="relative">
      ...
      >
        <div className="w-8 h-8 bg-linear-to-br from-blue-400 to-purple-400 rounded-full flex items-center justify-center text-white font-bold text-sm">
          {initial}
        </div>
